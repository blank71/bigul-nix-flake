...
\\
\>[B]{}\Varid{bx}\mathrel{=}\Conid{Replace}\mathbin{`\Conid{Prod}`}\mathbin{\$}(\Varid{rearrS}\;[\mskip1.5mu \mid \lambda (\Varid{n},\anonymous )\to \Varid{n}\mid \mskip1.5mu])\;\Conid{Replace}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
The problem is then how to determine the correspondences between sources and views in the two lists, so \ensuremath{\Varid{bx}} can be applied to the right pairs.
...
In general, we can abstract the source and view types and \ensuremath{\Varid{bx}} and \ensuremath{\Varid{cr}} as parameters, so the alignment program we write can be widely applicable.
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{},\mathbin{\$}(\Varid{normalSV}\;[\mskip1.5mu \Varid{p}\mid \anonymous \mathbin{:}\anonymous \mid \mskip1.5mu]\;[\mskip1.5mu \Varid{p}\mid \anonymous \mathbin{:}\anonymous \mid \mskip1.5mu]\;[\mskip1.5mu \Varid{p}\mid \anonymous \mathbin{:}\anonymous \mid \mskip1.5mu]){}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Longrightarrow\mathbin{\$}(\Varid{update}\;[\mskip1.5mu \Varid{p}\mid \Varid{x}\mathbin{:}\Varid{xs}\mid \mskip1.5mu]\;[\mskip1.5mu \Varid{p}\mid \Varid{x}\mathbin{:}\Varid{xs}\mid \mskip1.5mu]\;[\mskip1.5mu \Varid{d}\mid \Varid{x}\mathrel{=}\Varid{b};\Varid{xs}\mathrel{=}\Varid{posAlign}\;\Varid{b}\;\Varid{c}\mid \mskip1.5mu]){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{},\mathbin{\$}(\Varid{adaptiveSV}\;[\mskip1.5mu \Varid{p}\mid \anonymous \mathbin{:}\anonymous \mid \mskip1.5mu]\;[\mskip1.5mu \Varid{p}\mid [\mskip1.5mu \mskip1.5mu]\mid \mskip1.5mu]){}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Longrightarrow\lambda \anonymous \;\anonymous \to [\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{},\mathbin{\$}(\Varid{adaptiveSV}\;[\mskip1.5mu \Varid{p}\mid [\mskip1.5mu \mskip1.5mu]\mid \mskip1.5mu]\;[\mskip1.5mu \Varid{p}\mid \anonymous \mathbin{:}\anonymous \mid \mskip1.5mu]){}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
...
In the normal branches, we use a new operation \ensuremath{\Varid{update}}, which is a more compact syntax for the common programming pattern in which both the source and view are rearranged into a product and then further updates are performed on corresponding components.
For example, the \ensuremath{\Varid{update}} in the second normal branch is shorthand for:
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mathbin{\$}(\Varid{rearrS}\;[\mskip1.5mu \mid \lambda (\Varid{x}\mathbin{:}\Varid{xs})\to (\Varid{x},\Varid{xs})\mid \mskip1.5mu]){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbin{\$}(\Varid{rearrV}\;[\mskip1.5mu \mid \lambda (\Varid{x}\mathbin{:}\Varid{xs})\to (\Varid{x},\Varid{xs})\mid \mskip1.5mu])\;{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{b}\mathbin{`\Conid{Prod}`}\Varid{posAlign}\;\Varid{b}\;\Varid{c}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks

The \ensuremath{\Varid{get}} direction of \ensuremath{\Varid{posAlign}} does exactly what we want it to do:
\begin{tabbing}\tt
~\char42{}Main\char62{}~get~\char40{}posAlign~bx~cr\char41{}~employees\\
\tt ~Just~\char91{}\char40{}0\char44{}\char34{}Zhenjiang\char34{}\char41{}\char44{}\char40{}1\char44{}\char34{}Josh\char34{}\char41{}\char44{}\char40{}2\char44{}\char34{}Jeremy\char34{}\char41{}\char93{}
\end{tabbing}
...
\begin{tabbing}\tt
~\char42{}Main\char62{}~put~\char40{}posAlign~bx~cr\char41{}~employees~updatedEmployees0\\
\tt ~Just~\char91{}\char40{}0\char44{}\char40{}\char34{}Zhenjiang\char34{}\char44{}1000\char41{}\char41{}\char44{}\char40{}2\char44{}\char40{}\char34{}Jeremy\char34{}\char44{}400\char41{}\char41{}\char93{}
\end{tabbing}
...
\begin{tabbing}\tt
~\char42{}Main\char62{}~put~\char40{}posAlign~bx~cr\char41{}~employees~updatedEmployees1\\
\tt ~Just~\char91{}\char40{}2\char44{}\char40{}\char34{}Jeremy\char34{}\char44{}1000\char41{}\char41{}\char44{}\char40{}0\char44{}\char40{}\char34{}Zhenjiang\char34{}\char44{}400\char41{}\char41{}\char44{}\char40{}1\char44{}\char40{}\char34{}Josh\char34{}\char44{}2000\char41{}\char41{}\char93{}
\end{tabbing}
...
Key-based alignment might seem much more complex than positional alignment, but, in fact, we can just revise \ensuremath{\Varid{posAlign}} to get a BiGUL program for key-based alignment!
...
\>[B]{}\Varid{keyAlign}{}\<[11]%
\>[11]{}\mathbin{::}{}\<[11E]%
\>[15]{}\Varid{forall}\;\Varid{a}\;\Varid{b}\;\Varid{k}\mathbin{\circ}(\Conid{Show}\;\Varid{a},\Conid{Show}\;\Varid{b},\Conid{Eq}\;\Varid{k}){}\<[E]%
\\
\>[11]{}\Rightarrow {}\<[11E]%
\>[15]{}(\Varid{a}\to \Varid{k})\to (\Varid{b}\to \Varid{k})\to \Conid{BiGUL}\;\Varid{a}\;\Varid{b}\to (\Varid{b}\to \Varid{a})\to \Conid{BiGUL}\;[\mskip1.5mu \Varid{a}\mskip1.5mu]\;[\mskip1.5mu \Varid{b}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{keyAlign}\;\Varid{ks}\;\Varid{kv}\;\Varid{b}\;\Varid{c}\mathrel{=}\Conid{Case}\;\bot {}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{},\mathbin{\$}(\Varid{normal}\;[\mskip1.5mu \mid \lambda (\Varid{s}\mathbin{:}\Varid{ss})\;(\Varid{v}\mathbin{:}\Varid{vs})\to \Varid{ks}\;\Varid{s}\equiv \Varid{kv}\;\Varid{v}\mid \mskip1.5mu]\;[\mskip1.5mu \Varid{p}\mid \anonymous \mathbin{:}\anonymous \mid \mskip1.5mu]){}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Longrightarrow\mathbin{\$}(\Varid{update}\;[\mskip1.5mu \Varid{p}\mid \Varid{x}\mathbin{:}\Varid{xs}\mid \mskip1.5mu]\;{}\<[31]%
\>[31]{}[\mskip1.5mu \Varid{p}\mid \Varid{x}\mathbin{:}\Varid{xs}\mid \mskip1.5mu]\;{}\<[E]%
\\
\>[31]{}[\mskip1.5mu \Varid{d}\mid \Varid{x}\mathrel{=}\Varid{b};\Varid{xs}\mathrel{=}\Varid{keyAlign}\;\Varid{ks}\;\Varid{kv}\;\Varid{b}\;\Varid{c}\mid \mskip1.5mu]){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{},\mathbin{\$}(\Varid{adaptiveSV}\;[\mskip1.5mu \Varid{p}\mid \anonymous \mathbin{:}\anonymous \mid \mskip1.5mu]\;[\mskip1.5mu \Varid{p}\mid [\mskip1.5mu \mskip1.5mu]\mid \mskip1.5mu]){}\<[E]%
\\
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{},\mathbin{\$}(\Varid{adaptive}\;[\mskip1.5mu \mid \lambda \Varid{ss}\;(\Varid{v}\mathbin{:}\Varid{vs})\to \Varid{kv}\;\Varid{v}\in \Varid{map}\;\Varid{ks}\;\Varid{ss}\mid \mskip1.5mu]){}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{},\mathbin{\$}(\Varid{adaptiveSV}\;[\mskip1.5mu \Varid{p}\mid \anonymous \mid \mskip1.5mu]\;[\mskip1.5mu \Varid{p}\mid \anonymous \mathbin{:}\anonymous \mid \mskip1.5mu]){}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
...
\begin{tabbing}\tt
~\char42{}Main\char62{}~get~\char40{}keyAlign~fst~fst~bx~cr\char41{}~employees\\
\tt ~Just~\char91{}\char40{}0\char44{}\char34{}Zhenjiang\char34{}\char41{}\char44{}\char40{}1\char44{}\char34{}Josh\char34{}\char41{}\char44{}\char40{}2\char44{}\char34{}Jeremy\char34{}\char41{}\char93{}
\end{tabbing}
Unlike positional alignment, view element deletion can now be reflected correctly:
\begin{tabbing}\tt
~\char42{}Main\char62{}~put~\char40{}keyAlign~fst~fst~bx~cr\char41{}~employees~updatedEmployees0\\
\tt ~Just~\char91{}\char40{}0\char44{}\char40{}\char34{}Zhenjiang\char34{}\char44{}1000\char41{}\char41{}\char44{}\char40{}2\char44{}\char40{}\char34{}Jeremy\char34{}\char44{}2000\char41{}\char41{}\char93{}
\end{tabbing}
And reordering as well:
\begin{tabbing}\tt
~\char42{}Main\char62{}~put~\char40{}keyAlign~fst~fst~bx~cr\char41{}~employees~updatedEmployees1\\
\tt ~Just~\char91{}\char40{}2\char44{}\char40{}\char34{}Jeremy\char34{}\char44{}2000\char41{}\char41{}\char44{}\char40{}0\char44{}\char40{}\char34{}Zhenjiang\char34{}\char44{}1000\char41{}\char41{}\char44{}\char40{}1\char44{}\char40{}\char34{}Josh\char34{}\char44{}400\char41{}\char41{}\char93{}
\end{tabbing}
...
\begin{tabbing}\tt
~\char42{}Main\char62{}~put~\char40{}keyAlign~fst~fst~bx~cr\char41{}~employees~updatedEmployees2\\
\tt ~Just~\char91{}\char40{}0\char44{}\char40{}\char34{}Zhenjiang\char34{}\char44{}1000\char41{}\char41{}\char44{}\char40{}100\char44{}\char40{}\char34{}Josh\char34{}\char44{}0\char41{}\char41{}\char44{}\char40{}1\char44{}\char40{}\char34{}Jeremy\char34{}\char44{}400\char41{}\char41{}\char93{}
\end{tabbing}
...
\ColumnHook
\end{hscode}\resethooks
For example, the delta we have in mind between \ensuremath{\Varid{employees}} and \ensuremath{\Varid{updatedEmployees2}} is \ensuremath{[\mskip1.5mu (\mathrm{0},\mathrm{0}),(\mathrm{1},\mathrm{1}),(\mathrm{2},\mathrm{2})\mskip1.5mu]}, which, in particular, associates the source and view entries for Josh since \ensuremath{(\mathrm{2},\mathrm{2})} is included, instead of \ensuremath{[\mskip1.5mu (\mathrm{0},\mathrm{0}),(\mathrm{1},\mathrm{1})\mskip1.5mu]}, which indicates that Josh's source entry is not associated with any view entry and should be deleted, and that Josh's view entry is not associated with any source entry and is thus new.
...
\\
\>[B]{}\Varid{deltaAlign}\;\Varid{b}\;\Varid{c}\mathrel{=}\Conid{Case}\;\bot {}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}[\mskip1.5mu \mathbin{\$}(\Varid{normal}\;[\mskip1.5mu \mid \lambda (\Varid{ss},\Varid{d})\;\Varid{vs}\to \Varid{length}\;\Varid{ss}\equiv \Varid{length}\;\Varid{vs}\mathrel{\wedge}\Varid{d}\equiv \Varid{idDelta}\;\Varid{ss}\mid \mskip1.5mu]\;[\mskip1.5mu \Varid{p}\mid \anonymous \mid \mskip1.5mu]){}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Longrightarrow\mathbin{\$}(\Varid{rearrS}\;[\mskip1.5mu \mid \lambda (\Varid{ss},\anonymous )\to \Varid{ss}\mid \mskip1.5mu])\mathbin{\$}\Varid{posAlign}\;\Varid{b}\;\Varid{c}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{},\mathbin{\$}(\Varid{adaptive}\;[\mskip1.5mu \mid \mathbin{\char92 \char95 }\anonymous \to \Varid{otherwise}\mid \mskip1.5mu]){}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Longrightarrow{}\<[10]%
...
When this is the case, it suffices to call \ensuremath{\Varid{posAlign}} to carry out an element-wise synchronization, since no rearrangement is required.
...
Only when performing \ensuremath{\Varid{put}} does supplying a delta make sense.
When performing \ensuremath{\Varid{get}}, however, we still need to supply a delta since it is part of the source; but there is natural choice, which is \ensuremath{\Varid{idDelta}}.
So we define:
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
...
\begin{tabbing}\tt
~\char42{}Main\char62{}~putDeltaAlign~bx~cr~employees\\
\tt ~~~~~~~~~~\char91{}\char40{}0\char44{}0\char41{}\char44{}~\char40{}1\char44{}1\char41{}\char44{}~\char40{}2\char44{}2\char41{}\char93{}~updatedEmployees2\\
\tt ~Just~\char91{}\char40{}0\char44{}\char40{}\char34{}Zhenjiang\char34{}\char44{}1000\char41{}\char41{}\char44{}\char40{}100\char44{}\char40{}\char34{}Josh\char34{}\char44{}400\char41{}\char41{}\char44{}\char40{}1\char44{}\char40{}\char34{}Jeremy\char34{}\char44{}2000\char41{}\char41{}\char93{}
\end{tabbing}
...
\begin{tabbing}\tt
~\char42{}Main\char62{}~putDeltaAlign~bx~cr~employees~\char91{}\char40{}0\char44{}0\char41{}\char44{}~\char40{}2\char44{}2\char41{}\char93{}\\
\tt ~~~~~~~~~~\char61{}\char60{}\char60{}~getDeltaAlign~bx~cr~employees\\
\tt ~Just~\char91{}\char40{}0\char44{}\char40{}\char34{}Zhenjiang\char34{}\char44{}1000\char41{}\char41{}\char44{}\char40{}1\char44{}\char40{}\char34{}Josh\char34{}\char44{}0\char41{}\char41{}\char44{}\char40{}2\char44{}\char40{}\char34{}Jeremy\char34{}\char44{}2000\char41{}\char41{}\char93{}
\end{tabbing}
...
\begin{tabbing}\tt
~\char42{}Main\char62{}~putDeltaAlignS~byPosition~bx~cr~employees~updatedEmployees0\\
\tt ~Just~\char91{}\char40{}0\char44{}\char40{}\char34{}Zhenjiang\char34{}\char44{}1000\char41{}\char41{}\char44{}\char40{}2\char44{}\char40{}\char34{}Jeremy\char34{}\char44{}400\char41{}\char41{}\char93{}\\
\tt ~\\
\tt ~\char42{}Main\char62{}~putDeltaAlignS~\char40{}byKey~fst~fst\char41{}~bx~cr~employees~updatedEmployees1\\
\tt ~Just~\char91{}\char40{}2\char44{}\char40{}\char34{}Jeremy\char34{}\char44{}2000\char41{}\char41{}\char44{}\char40{}0\char44{}\char40{}\char34{}Zhenjiang\char34{}\char44{}1000\char41{}\char41{}\char44{}\char40{}1\char44{}\char40{}\char34{}Josh\char34{}\char44{}400\char41{}\char41{}\char93{}
\end{tabbing}
