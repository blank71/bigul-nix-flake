...
a \ensuremath{\Varid{get}} function will typically not be injective, so there may exist
...
Interestingly\todo{Tony I'm not sure I understand why this is particularly "interesting".}, while \ensuremath{\Varid{get}} usually loses information
...
We say that a \ensuremath{\Varid{put}} function is {\em valid} if there exists a \ensuremath{\Varid{get}} function
...
check the validity of \ensuremath{\Varid{put}} without mentioning \ensuremath{\Varid{get}}.
The following are two important properties of \ensuremath{\Varid{put}}.
\begin{itemize}
\item 
...
the validity of \ensuremath{\Varid{put}} \cite{FiHP15b}. 
\begin{theorem}
\label{th:put2}
