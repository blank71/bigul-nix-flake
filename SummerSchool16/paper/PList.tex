...
We shall focus on \ensuremath{\Varid{foldr}}, which is a simple but useful higher order function on lists:\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
...
\ColumnHook
\end{hscode}\resethooks
where many interesting functions can be defined in \ensuremath{\Varid{foldr}}\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
...
\ColumnHook
\end{hscode}\resethooks
First, we develop a putback version for \ensuremath{\Varid{foldr}}.
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{lensFoldr}\mathbin{::}(\Conid{Show}\;\Varid{a},\Conid{Show}\;\Varid{b})\Rightarrow \Conid{BiGUL}\;(\Varid{a},\Varid{b})\;\Varid{b}\to (\Varid{b}\to \Conid{Bool})\to \Conid{BiGUL}\;([\mskip1.5mu \Varid{a}\mskip1.5mu],\Varid{b})\;\Varid{b}{}\<[E]%
\\
...
\\
\>[9]{},{}\<[9E]%
\>[12]{}\mathbin{\$}(\Varid{normal}\;[\mskip1.5mu \mid \lambda (\Varid{s},\anonymous )\;\Varid{v}\to \Varid{null}\;\Varid{s}\mid \mskip1.5mu]\;[\mskip1.5mu \mid \lambda (\Varid{s},\anonymous )\to \Varid{null}\;\Varid{s}\mid \mskip1.5mu]){}\<[E]%
\\
\>[12]{}\hsindent{2}{}\<[14]%
\>[14]{}\Longrightarrow\mathbin{\$}(\Varid{rearrV}\;[\mskip1.5mu \mid \lambda \Varid{v}\to ((),\Varid{v})\mid \mskip1.5mu])\mathbin{\$}{}\<[E]%
\\
\>[14]{}\hsindent{7}{}\<[21]%
\>[21]{}\mathbin{\$}(\Varid{update}\;[\mskip1.5mu \Varid{p}\mid (\anonymous ,\Varid{v})\mid \mskip1.5mu]\;[\mskip1.5mu \Varid{p}\mid ((),\Varid{v})\mid \mskip1.5mu]\;[\mskip1.5mu \Varid{d}\mid \Varid{v}\mathrel{=}\Conid{Replace}\mid \mskip1.5mu]){}\<[E]%
\\
\>[9]{},{}\<[9E]%
\>[12]{}\mathbin{\$}(\Varid{normalSV}\;[\mskip1.5mu \Varid{p}\mid \anonymous \mid \mskip1.5mu]\;[\mskip1.5mu \Varid{p}\mid \anonymous \mid \mskip1.5mu]\;[\mskip1.5mu \mid \lambda (\Varid{s},\anonymous )\to not\;(\Varid{null}\;\Varid{s})\mid \mskip1.5mu]){}\<[E]%
\\
\>[12]{}\hsindent{2}{}\<[14]%
\>[14]{}\Longrightarrow\mathbin{\$}(\Varid{rearrS}\;[\mskip1.5mu \mid \lambda ((\Varid{x}\mathbin{:}\Varid{xs}),\Varid{e})\to (\Varid{x},(\Varid{xs},\Varid{e})){}\<[59]%
\>[59]{}\mid \mskip1.5mu]){}\<[E]%
\\
\>[14]{}\hsindent{2}{}\<[16]%
\>[16]{}(\Conid{Replace}\mathbin{`\Conid{Prod}`}\Varid{lensFoldr}\;\Varid{bx}\;\Varid{pv})\mathbin{`\Conid{Compose}`}\Varid{bx}{}\<[E]%
\\
\>[9]{}\mskip1.5mu]{}\<[9E]%
\ColumnHook
\end{hscode}\resethooks
\ensuremath{\Varid{lengFoldr}\;\Varid{bx}\;\Varid{pv}} is to synchronize source \ensuremath{(\Varid{xs},\Varid{v})} with view \ensuremath{\Varid{v'}}.
If \ensuremath{\Varid{v'}} satisfies \ensuremath{\Varid{pv}}, it will stop. Otherwise,
it will recursively apply \ensuremath{\Varid{bx}} rightwards over the elements of \ensuremath{\Varid{xs}}.
\ignore{
...
\ensuremath{\Varid{lensFoldr}}. As the first example, we consider bidirectionalize \ensuremath{\Varid{map}}.
It can be easily defined in terms of \ensuremath{\Varid{lensFoldr}}.
...
\end{tabbing}
Now we give another example of \ensuremath{\Varid{reverse}}.
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{16}{@{}>{\hspre}l<{\hspost}@{}}%
