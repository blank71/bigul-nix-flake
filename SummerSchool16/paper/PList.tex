...
\\
\>[3]{}\Varid{filter}\;\Varid{p}{}\<[14]%
\>[14]{}\mathrel{=}\Varid{foldr}\;(\lambda \Varid{a}\;\Varid{r}\to \mathbf{if}\;\Varid{p}\;\Varid{a}\;\mathbf{then}\;\Varid{a}\mathbin{:}\Varid{r}\;\mathbf{else}\;\Varid{r})\;[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[3]{}\Varid{reverse}\;\Varid{p}{}\<[14]%
\>[14]{}\mathrel{=}\Varid{foldr}\;(\lambda \Varid{a}\;\Varid{r}\to \Varid{r}\plus [\mskip1.5mu \Varid{a}\mskip1.5mu])\;[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[3]{}\Varid{sort}{}\<[14]%
\>[14]{}\mathrel{=}\Varid{foldr}\;\Varid{insert}\;[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\>[12]{}\mathbin{::}{}\<[12E]%
\>[16]{}(\Conid{Show}\;\Varid{a},\Conid{Show}\;\Varid{b}){}\<[E]%
\\
\>[12]{}\Rightarrow {}\<[12E]%
\>[16]{}\Conid{BiGUL}\;(\Varid{a},\Varid{b})\;\Varid{b}\to (\Varid{b}\to \Conid{Bool})\to \Conid{BiGUL}\;([\mskip1.5mu \Varid{a}\mskip1.5mu],\Varid{b})\;\Varid{b}{}\<[E]%
\\
