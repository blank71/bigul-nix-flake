...
\ColumnHook
\end{hscode}\resethooks
This is a nice representation for the compiler, but we cannot expect the programmer to write something like ``\ensuremath{\Conid{Sub}\;(\Conid{Num}\;\mathrm{1})\;(\Conid{Add}\;(\Conid{Num}\;\mathrm{2})\;(\Conid{Num}\;\mathrm{3}))}'', and should provide a concrete syntax so they can write ``$1 - (2+3)$''.
...
\column{11}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mathbin{\$}(\Varid{update}\;{}\<[11]%
\>[11]{}[\mskip1.5mu \Varid{p}\mid \Conid{Plus}\;\Varid{l}\;\Varid{r}\mid \mskip1.5mu]\;[\mskip1.5mu \Varid{p}\mid \Conid{Add}\;\Varid{l}\;\Varid{r}\mid \mskip1.5mu]\;{}\<[E]%
\\
\>[11]{}[\mskip1.5mu \Varid{d}\mid \Varid{l}\mathrel{=}\Varid{pExpArith};\Varid{r}\mathrel{=}\Varid{pFactorArith}\mid \mskip1.5mu]){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}[\mskip1.5mu \mathbin{\$}(\Varid{normalSV}\;[\mskip1.5mu \Varid{p}\mid \Conid{Plus}\;\anonymous \;\anonymous \mid \mskip1.5mu]\;[\mskip1.5mu \Varid{p}\mid \Conid{Add}\;\anonymous \;\anonymous \mid \mskip1.5mu]\;[\mskip1.5mu \Varid{p}\mid \Conid{Plus}\;\anonymous \;\anonymous \mid \mskip1.5mu]){}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Longrightarrow\mathbin{\$}(\Varid{update}\;{}\<[19]%
\>[19]{}[\mskip1.5mu \Varid{p}\mid \Conid{Plus}\;\Varid{l}\;\Varid{r}\mid \mskip1.5mu]\;[\mskip1.5mu \Varid{p}\mid \Conid{Add}\;\Varid{l}\;\Varid{r}\mid \mskip1.5mu]\;{}\<[E]%
\\
\>[19]{}[\mskip1.5mu \Varid{d}\mid \Varid{l}\mathrel{=}\Varid{pExpArith};\Varid{r}\mathrel{=}\Varid{pFactorArith}\mid \mskip1.5mu]){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{},\mathbin{\$}(\Varid{normalSV}\;[\mskip1.5mu \Varid{p}\mid \Conid{Minus}\;\anonymous \;\anonymous \mid \mskip1.5mu]\;[\mskip1.5mu \Varid{p}\mid \Conid{Sub}\;\anonymous \;\anonymous \mid \mskip1.5mu]\;[\mskip1.5mu \Varid{p}\mid \Conid{Minus}\;\anonymous \;\anonymous \mid \mskip1.5mu]){}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Longrightarrow\mathbin{\$}(\Varid{update}\;{}\<[19]%
\>[19]{}[\mskip1.5mu \Varid{p}\mid \Conid{Minus}\;\Varid{l}\;\Varid{r}\mid \mskip1.5mu]\;[\mskip1.5mu \Varid{p}\mid \Conid{Sub}\;\Varid{l}\;\Varid{r}\mid \mskip1.5mu]\;{}\<[E]%
\\
\>[19]{}[\mskip1.5mu \Varid{d}\mid \Varid{l}\mathrel{=}\Varid{pExpArith};\Varid{r}\mathrel{=}\Varid{pFactorArith}\mid \mskip1.5mu]){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{},\mathbin{\$}(\Varid{normalSV}\;[\mskip1.5mu \Varid{p}\mid \Conid{EF}\;\anonymous \mid \mskip1.5mu]\;[\mskip1.5mu \Varid{p}\mid \anonymous \mid \mskip1.5mu]\;[\mskip1.5mu \Varid{p}\mid \Conid{EF}\;\anonymous \mid \mskip1.5mu]){}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Longrightarrow\mathbin{\$}(\Varid{update}\;{}\<[19]%
\>[19]{}[\mskip1.5mu \Varid{p}\mid \Conid{EF}\;\Varid{t}\mid \mskip1.5mu]\;[\mskip1.5mu \Varid{p}\mid \Varid{t}\mid \mskip1.5mu]\;{}\<[E]%
\\
\>[19]{}[\mskip1.5mu \Varid{d}\mid \Varid{t}\mathrel{=}\Varid{pFactorArith}\mid \mskip1.5mu]){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}[\mskip1.5mu \mathbin{\$}(\Varid{normalSV}\;[\mskip1.5mu \Varid{p}\mid \Conid{Lit}\;\anonymous \mid \mskip1.5mu]\;[\mskip1.5mu \Varid{p}\mid \Conid{Num}\;\anonymous \mid \mskip1.5mu]\;[\mskip1.5mu \Varid{p}\mid \Conid{Lit}\;\anonymous \mid \mskip1.5mu]){}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Longrightarrow\mathbin{\$}(\Varid{update}\;[\mskip1.5mu \Varid{p}\mid \Conid{Lit}\;\Varid{i}\mid \mskip1.5mu]\;[\mskip1.5mu \Varid{p}\mid \Conid{Num}\;\Varid{i}\mid \mskip1.5mu]\;[\mskip1.5mu \Varid{d}\mid \Varid{i}\mathrel{=}\Conid{Replace}\mid \mskip1.5mu]){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{},\mathbin{\$}(\Varid{normalSV}\;[\mskip1.5mu \Varid{p}\mid \Conid{Neg}\;\anonymous \mid \mskip1.5mu]\;[\mskip1.5mu \Varid{p}\mid \Conid{Sub}\;(\Conid{Num}\;\mathrm{0})\;\anonymous \mid \mskip1.5mu]\;[\mskip1.5mu \Varid{p}\mid \Conid{Neg}\;\anonymous \mid \mskip1.5mu]){}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Longrightarrow\mathbin{\$}(\Varid{update}\;[\mskip1.5mu \Varid{p}\mid \Conid{Neg}\;\Varid{t}\mid \mskip1.5mu]\;[\mskip1.5mu \Varid{p}\mid \Conid{Sub}\;(\Conid{Num}\;\mathrm{0})\;\Varid{t}\mid \mskip1.5mu]\;[\mskip1.5mu \Varid{d}\mid \Varid{t}\mathrel{=}\Varid{pFactorArith}\mid \mskip1.5mu]){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{},\mathbin{\$}(\Varid{normalSV}\;[\mskip1.5mu \Varid{p}\mid \Conid{Paren}\;\anonymous \mid \mskip1.5mu]\;[\mskip1.5mu \Varid{p}\mid \anonymous \mid \mskip1.5mu]\;[\mskip1.5mu \Varid{p}\mid \Conid{Paren}\;\anonymous \mid \mskip1.5mu]){}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Longrightarrow\mathbin{\$}(\Varid{update}\;[\mskip1.5mu \Varid{p}\mid \Conid{Paren}\;\Varid{t}\mid \mskip1.5mu]\;[\mskip1.5mu \Varid{p}\mid \Varid{t}\mid \mskip1.5mu]\;[\mskip1.5mu \Varid{d}\mid \Varid{t}\mathrel{=}\Varid{pExpArith}\mid \mskip1.5mu]){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mskip1.5mu]{}\<[E]%
\ColumnHook
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}{\color[gray]{0.6}^\$(}\Varid{adaptiveSV}\;{\color[gray]{0.6}[\mskip1.5mu \textit p\kern-2pt\mid }\;\anonymous \;{\color[gray]{0.6}\mid \mskip1.5mu]}\;{\color[gray]{0.6}[\mskip1.5mu \textit p\kern-2pt\mid }\;\Conid{Add}\;\anonymous \;\anonymous \;{\color[gray]{0.6}\mid \mskip1.5mu]}{\color[gray]{0.6})}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
...
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Longrightarrow\mathbin{\$}(\Varid{update}\;[\mskip1.5mu \Varid{p}\mid \Conid{Plus}\;\Varid{l}\;\Varid{r}\mid \mskip1.5mu]\;[\mskip1.5mu \Varid{p}\mid \Conid{Add}\;\Varid{l}\;\Varid{r}\mid \mskip1.5mu]\;{}\<[E]%
\\
\>[5]{}\hsindent{13}{}\<[18]%
\>[18]{}[\mskip1.5mu \Varid{d}\mid \Varid{l}\mathrel{=}\Varid{pExpArith};\Varid{r}\mathrel{=}\Varid{pFactorArith}\mid \mskip1.5mu]){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{},\mathbin{\$}(\Varid{normalSV}\;[\mskip1.5mu \Varid{p}\mid \Conid{Minus}\;\anonymous \;\anonymous \mid \mskip1.5mu]\;[\mskip1.5mu \Varid{p}\mid \Conid{Sub}\;\anonymous \;\anonymous \mid \mskip1.5mu]\;[\mskip1.5mu \Varid{p}\mid \Conid{Minus}\;\anonymous \;\anonymous \mid \mskip1.5mu]){}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Longrightarrow\mathbin{\$}(\Varid{update}\;[\mskip1.5mu \Varid{p}\mid \Conid{Minus}\;\Varid{l}\;\Varid{r}\mid \mskip1.5mu]\;[\mskip1.5mu \Varid{p}\mid \Conid{Sub}\;\Varid{l}\;\Varid{r}\mid \mskip1.5mu]\;{}\<[E]%
\\
\>[5]{}\hsindent{13}{}\<[18]%
\>[18]{}[\mskip1.5mu \Varid{d}\mid \Varid{l}\mathrel{=}\Varid{pExpArith};\Varid{r}\mathrel{=}\Varid{pFactorArith}\mid \mskip1.5mu]){}\<[E]%
\\
...
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Longrightarrow\mathbin{\$}(\Varid{update}\;[\mskip1.5mu \Varid{p}\mid \Conid{EF}\;\Varid{t}\mid \mskip1.5mu]\;[\mskip1.5mu \Varid{p}\mid \Varid{t}\mid \mskip1.5mu]\;{}\<[E]%
\\
\>[5]{}\hsindent{13}{}\<[18]%
\>[18]{}[\mskip1.5mu \Varid{d}\mid \Varid{t}\mathrel{=}\Varid{pFactorArith}\mid \mskip1.5mu]){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{},\mathbin{\$}(\Varid{adaptiveSV}\;[\mskip1.5mu \Varid{p}\mid \anonymous \mid \mskip1.5mu]\;[\mskip1.5mu \Varid{p}\mid \Conid{Add}\;\anonymous \;\anonymous \mid \mskip1.5mu]){}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Longrightarrow\lambda \anonymous \;\anonymous \to \Conid{Plus}\;\Conid{ENull}\;\Conid{FNull}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{},\mathbin{\$}(\Varid{adaptiveSV}\;[\mskip1.5mu \Varid{p}\mid \anonymous \mid \mskip1.5mu]\;[\mskip1.5mu \Varid{p}\mid \Conid{Sub}\;\anonymous \;\anonymous \mid \mskip1.5mu]){}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Longrightarrow\lambda \anonymous \;\anonymous \to \Conid{Minus}\;\Conid{ENull}\;\Conid{FNull}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{},\mathbin{\$}(\Varid{adaptiveSV}\;[\mskip1.5mu \Varid{p}\mid \anonymous \mid \mskip1.5mu]\;[\mskip1.5mu \Varid{p}\mid \anonymous \mid \mskip1.5mu]){}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{},\mathbin{\$}(\Varid{adaptiveSV}\;[\mskip1.5mu \Varid{p}\mid \anonymous \mid \mskip1.5mu]\;[\mskip1.5mu \Varid{p}\mid \Conid{Num}\;\anonymous \mid \mskip1.5mu]){}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Longrightarrow\lambda \anonymous \;\anonymous \to \Conid{Lit}\;\mathrm{0}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{},\mathbin{\$}(\Varid{adaptiveSV}\;[\mskip1.5mu \Varid{p}\mid \anonymous \mid \mskip1.5mu]\;[\mskip1.5mu \Varid{p}\mid \Conid{Sub}\;(\Conid{Num}\;\mathrm{0})\;\anonymous \mid \mskip1.5mu]){}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mathbin{\$}(\Varid{adaptiveSV}\;[\mskip1.5mu \Varid{p}\mid \anonymous \mid \mskip1.5mu]\;[\mskip1.5mu \Varid{p}\mid \Conid{Sub}\;(\Conid{Num}\;\mathrm{0})\;\anonymous \mid \mskip1.5mu]){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
