...
\begin{spec}
S(normalSV (P(Plus _ _)) (P(Add _ _)) (P(Plus _ _)))
  ==>  (S(rearrS (Q(\(Plus l r) -> (l, r)))))
         (S(rearrV (Q(\(Add l r) -> (l, r)))))
...
pExpArith  =   Case
  [ S(normalSV (P(Plus _ _)) (P(Add _ _)) (P(Plus _ _)))
    ==> S(update  (P(Plus l r)) (P(Add l r))
                  (D(l = pExpArith; r = pFactorArith)))
  , S(normalSV (P(Minus _ _)) (P(Sub _ _)) (P(Minus _ _)))
    ==> S(update  (P(Minus l r)) (P(Sub l r))
                  (D(l = pExpArith; r = pFactorArith)))
  , S(normalSV (P(EF _)) (P(_)) (P(EF _)))
    ==> S(update  (P(EF t)) (P(t))
                  (D(t = pFactorArith)))
  ]
...
pFactorArith  ::   BiGUL Factor Arith
pFactorArith  =    Case
  [ S(normalSV (P(Lit _)) (P(Num _)) (P(Lit _)))
    ==> S(update (P(Lit i)) (P(Num i)) (D(i = Replace)))
  , S(normalSV (P(Neg _)) (P(Sub (Num 0) _)) (P(Neg _)))
    ==> S(update (P(Neg t)) (P(Sub (Num 0) t)) (D(t = pFactorArith)))
  , S(normalSV (P(Paren _)) (P(_)) (P(Paren _)))
    ==> S(update (P(Paren t)) (P(t)) (D(t = pExpArith)))
  ]
\end{spec}
...
pExpArith  =   Case
  ...
  , S(adaptiveSV (P(_)) (P(Add _ _)))
    ==> \ _ _ -> Plus ENull FNull
  , S(adaptiveSV (P(_)) (P(Sub _ _)))
    ==> \ _ _ -> Minus ENull FNull
  , S(adaptiveSV (P(_)) (P(_)))
    ==> \ _ _ -> EF FNull
  ]
