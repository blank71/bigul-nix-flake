...
\end{code}
This tells us that if |b|~is capable of producing everything, then |keyAlign ks kv b c| can also produce everything.
...
\paragraph{\BiGUL\ claims to be putback-based but is still a lens language. Is there really a fundamental difference between \BiGUL\ and previous lens languages?}
...
We might say that the fundamental problem with those reasoning principles is that they are only auxiliary and cannot help the programmer to understand program behaviour without breaking the abstraction and reasoning in terms of the semantic definitions of the languages.
