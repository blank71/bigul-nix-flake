...
The proof of this theorem (which is by induction on the proof rules in \autoref{fig:putback-proof-rules} as usual) has been checked in the accompanying \Agda\ formalisation, and is omitted from the presentation.
