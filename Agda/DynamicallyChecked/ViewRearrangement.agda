...
Expr spat vpat = ⟦ spat ⟧ᴾ (VarPath vpat)

evals : {G : U n} (spat : Pattern F G) {H : U n} (vpat : Pattern F H) → Expr spat vpat → PatResult vpat → PatResult spat
evals var              vpat p              vs = retrieve p vs
evals (k x           ) vpat expr           vs = tt
evals (child spat    ) vpat expr           vs = evals spat vpat expr vs
evals (left spat     ) vpat expr           vs = evals spat vpat expr vs
evals (right spat    ) vpat expr           vs = evals spat vpat expr vs
evals (prod lpat rpat) vpat (expr , expr') vs = evals lpat vpat expr vs , evals rpat vpat expr' vs
evals (elem hpat tpat) vpat (expr , expr') vs = evals hpat vpat expr vs , evals tpat vpat expr' vs

eval : {G : U n} (spat : Pattern F G) {H : U n} (vpat : Pattern F H) → Expr spat vpat → ⟦ H ⟧ (μ F) → Par (⟦ G ⟧ (μ F))
eval spat vpat expr = liftPar (construct spat ∘ evals spat vpat expr) ∘ deconstruct vpat
