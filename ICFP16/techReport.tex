...
a good language for programming \ensuremath{\Varid{put}} cannot only
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\Varid{get}\mathbin{::}\Conid{Source}\to \Conid{View}{}\<[E]%
\\
\>[3]{}\Varid{put}\mathbin{::}\Conid{Source}\to \Conid{View}\to \Conid{View}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
where 
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\Varid{getHeight}\;(\Varid{height},\Varid{width})\mathrel{=}\Varid{height}{}\<[E]%
\\
\>[3]{}\Varid{putHeight}\;(\Varid{height},\Varid{width})\;\Varid{height'}\mathrel{=}(\Varid{height'},\Varid{width}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
and derive the unique \ensuremath{\Varid{get}} if there is \cite{PaHF14,PachecoZH14,HuPF14,FischerHP15,Ko2016}.
\end{itemize}
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mathbf{type}\;\Conid{Source}\mathrel{=}(\Conid{Int},(\Conid{Char},\Conid{Int})){}\<[E]%
\\
\>[B]{}\mathbf{type}\;\Conid{View}\mathrel{=}(\Conid{Int},\Conid{Char}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
%
The first component of the pair should match the first component of the view,
and the character component (\ensuremath{\Conid{Char}}) of the source should match the character
...
position, i.e., the identity delta. However, the delta being the same as \ensuremath{\Varid{getIdL}\;\Varid{v}} doesn't mean that no changes were performed to the view, e.g., some values
...
The embedding of \ensuremath{\Varid{get}} and \ensuremath{\Varid{put}} functions can be defined as a BiGUL program:
%
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
