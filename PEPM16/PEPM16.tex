...
\end{code}
Note that the view type is specified as the unit type~|^^^⊤| (whose only inhabitant is~|^^^tt|) --- had the view type been a more complex type, there would have been no way for |get| to decide what to return.
